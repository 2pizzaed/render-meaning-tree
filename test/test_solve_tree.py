...
SEQUENCE_CASES: list[tuple[object, ...]] = [
    ...
    (
        ...
        """,
        {
            ...
            4: ["first"],
            6: ["next_cond"],
            7: ["BEGIN", "END", "if_branch"],
            8: ["first"],
            10: ["next_cond"],
            11: ["BEGIN", "END", "if_branch"],
            12: ["first"],
        },
        [(1, 0), (2, 1), (6, 0), (10, 0), (15, 2), (15, 0), (16, 0), (15, 1), (18, 0)],
    ...
    (
        ...
        [(1, 0), (2, 1), (6, 0), (10, 0), (11, 2), (11, 0), (12, 0), (11, 1), (14, 0)],
    ...
    (
        ...
        [(11, 1), (6, 2), (6, 0), (7, 1), (2, 2), (2, 0), (3, 0), (7, 2), (6, 1), (11, 2), (12, 0)],
    ...
    (
        ...
        {
            1: ["first"],
            2: ["next", "first_cond", "BEGIN", "END", "if_branch"],
            3: ["first"],
            5: ["next_cond", "BEGIN", "END", "if_branch"],
            6: ["first"],
            8: ["next_cond", "BEGIN", "END", "if_branch"],
            9: ["first"],
            11: ["BEGIN", "END", "else_branch"],
            12: ["first"],
            14: ["next"],
        },
        [(1, 0), (2, 1), (5, 0), (8, 0), (11, 2), (11, 0), (12, 0), (11, 1), (14, 0)],
    ...
    (
        ...
        [(1, 0), (2, 1), (5, 0), (8, 0), (8, 3), (8, 1), (9, 0), (8, 2), (11, 0)],
    ...
    (
        ...
        {
            1: ["first"],
            2: ["next", "cond", "init", "BEGIN", "END", "body"],
            3: ["first"],
            5: ["next"],
        },
        [
    ...
    (
        ...
        {
            1: ["first"],
            2: ["next", "cond", "BEGIN", "END", "body"],
            3: ["first"],
            5: ["next"],
        },
        [(1, 0), (2, 1), (2, 4), (2, 2), (3, 0), (5, 0)],
        "java_break.loqi",
    ),
    (
        "java",
    ...
    (
        ...
        [(10, 1), (5, 3), (5, 1), (6, 1), (1, 3), (1, 1), (2, 0), (6, 2), (5, 2), (10, 2)],
